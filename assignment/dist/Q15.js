...
let dinnerGuests = ['Mr Zia', 'Choudhary Zafar', 'Qasim Farooqi'];
...
const gwhocantmakeit = 'Choudhary Zafar';
console.log(`${gwhocantmakeit} cant make it to dinner.\n`);
// replace the invitation to cant make it with new invitee
dinnerGuests = dinnerGuests.map((guest) => guest === gwhocantmakeit ? "Saddam Hussain" : guest);
